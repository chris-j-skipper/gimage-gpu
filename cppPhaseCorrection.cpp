...
VectorXYZ PhaseCorrection::multMatrixVector( Matrix3x3 pMatrix, VectorXYZ pVector )
{
...
Matrix3x3 PhaseCorrection::multMatrix( Matrix3x3 pMatrix1, Matrix3x3 pMatrix2 )
{
...
Matrix3x3 PhaseCorrection::transpose( Matrix3x3 pOldMatrix )
{
...
Matrix3x3 PhaseCorrection::inverse2x2( Matrix3x3 pOldMatrix )
{
...
Matrix3x3 PhaseCorrection::rotateX( double pAngle )
{
...
Matrix3x3 PhaseCorrection::rotateY( double pAngle )
{
...
Matrix3x3 PhaseCorrection::rotateZ( double pAngle )
{
...
Matrix3x3 PhaseCorrection::convertXYZtoUVW( PolarCoords pCoords )
{
...
Matrix3x3 PhaseCorrection::convertUVWtoXYZ( PolarCoords pCoords )
{
...
Matrix3x3 PhaseCorrection::epochConversionMatrix( double pNP_RA, double pNP_DEC, double pNP_RA_OFFSET )
{
...
Matrix3x3 PhaseCorrection::doEpochConversion( PolarCoords pIn, PolarCoords pOut )
{
...
double PhaseCorrection::getPathLengthDifference( VectorXYZ pUVW )
{
	...
	inUVW.y = 0;
	inUVW.z = 1;
	VectorXYZ phaseI = multMatrixVector( _uvwRotation, inUVW );
	...
	VectorXYZ uvwRotated = multMatrixVector( _uvwRotation, pUVW );
...
Matrix3x3 PhaseCorrection::reprojectUV()
{
	...
	Matrix3x3 rotationMatrixReduced;
...
void PhaseCorrection::init()
{
	...
	//VectorXYZ tmpUVW = multMatrixVector( _uvwRotation, uvwIn );
